//
//  secondToturialViewController.swift
//  Stita
//
...
class secondToturialViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        nextBtn.backgroundColor = UIColor(red: 0.10, green: 0.58, blue: 0.73, alpha: 1.00)
             //  UIApplication.shared.statusBarView?.backgroundColor = UIColor(red: 0.10, green: 0.58, blue: 0.73, alpha: 1.00)
